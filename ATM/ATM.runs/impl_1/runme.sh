...
HD_PWD='D:/Stefan/UTCN/An 1 Sem 2/DSD/Proiect_ATM/final/ATM/ATM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Interface.tcl -notrace
